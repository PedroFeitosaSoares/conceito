...
class HTMLInformationExtractor:
    @staticmethod
            ...
            for legenda in legendas:
                ...
                if tabela:
                    ...
                    if legenda == "Movimentações do Processo":
                        dataframes[legenda] = HTMLInformationExtractor.tratamento_movimentacoes_processos(df)
                    if legenda == "Documentos do Processo":
                        dataframes[legenda] = HTMLInformationExtractor.tratamento_documentos_processos(df)
    ...
    def extrair_data(URL):
        ...
        tabelas_df = HTMLInformationExtractor.extrair_tabelas_para_dataframe(URL, legendas_tabelas)
        ...
        HTMLInformationExtractor.buscar_por_nome_e_exportar_csv(URL, 'Dados Gerais do Processo', 'dados_gerais_processo.csv')
